...
const GUIDE_CONTENT = {
  en: {
    ...
    "anonymous-venting": {
      ...
      headline: "Some thoughts only need to be named, softened, and released.",
      intro: "Cyber Vent lets you type what feels heavy and release it as a bubble animation. The worry is not saved to the backend.",
      sections: [
        ...
        ["After release", "Notice whether your shoulders, jaw, or breathing changed even slightly. Small changes still count."]
      ],
      cta: "Use Cyber Vent",
  ...
  zh: {
    ...
    "anonymous-venting": {
      ...
      intro: "赛博解压池允许你写下此刻很重的事情，再把它揉成气泡放走。内容不会保存到后台。",
      sections: [
        ["隐私为什么重要", "真正的释放不该让你担心以后谁会读到。OASIS 特意把这个仪式留在浏览器里。"],
        ["写得简单就好", "一句话、一个词、一段乱糟糟的草稿都可以。重点是表达，不是写得漂亮。"],
        ["释放之后", "可以留意一下肩膀、下颌或呼吸有没有轻一点点。哪怕只有一点点，也是真实变化。"]
      ],
      cta: "进入赛博解压池",
  ...
  tc: {
    ...
    "anonymous-venting": {
      ...
      intro: "賽博解壓池允許你寫下此刻很重的事情，再把它揉成氣泡放走。內容不會保存到後台。",
      sections: [
        ["隱私為什麼重要", "真正的釋放不該讓你擔心以後誰會讀到。OASIS 特意把這個儀式留在瀏覽器裡。"],
        ["寫得簡單就好", "一句話、一個詞、一段亂糟糟的草稿都可以。重點是表達，不是寫得漂亮。"],
        ["釋放之後", "可以留意一下肩膀、下顎或呼吸有沒有輕一點點。哪怕只有一點點，也是真實變化。"]
      ],
      cta: "進入賽博解壓池",
